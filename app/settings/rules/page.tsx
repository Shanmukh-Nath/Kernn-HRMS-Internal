...
export default function AttendanceRulesPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-12">
      ...
      <div className="flex items-center gap-2 bg-slate-100 p-1.5 rounded-2xl border border-slate-200 overflow-x-auto no-scrollbar">
        <div className="px-4 py-2 rounded-xl text-xs font-bold bg-white text-slate-900 shadow-xs flex items-center gap-2 whitespace-nowrap">
          <Clock className="w-3.5 h-3.5 text-[#a92427]" />
          <span>1. Shift & Timing Rules</span>
        </div>
        <Link
          href="/leaves?tab=POLICIES"
          className="px-4 py-2 rounded-xl text-xs font-bold text-slate-600 hover:text-slate-900 hover:bg-white/60 transition flex items-center gap-2 whitespace-nowrap"
        >
          <Palmtree className="w-3.5 h-3.5 text-blue-600" />
          <span>2. Leave Policies & Accruals</span>
